...
from workflow.state import SupportAgentState, SupportTicket
from workflow.nodes import SupportNodes
from workflow.edges import review_decision, category_router
...
[Final Output] ←← [Approved?] ←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←←
      ...
      ↑                 ↓
[Escalation] ←← [Max Retries?] ←← [Context Refinement] → [Redraft Generation]
                                              ↑                    ↓
                                              ←←←←←←← [Review] ←←←←←
