...
class SupportNodes:
    ...
    async def classification_node(self, state: SupportAgentState) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Classified ticket as: {classification.category} (confidence: {classification.confidence})")
    ...
    async def rag_retrieval_node(self, state: SupportAgentState) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Retrieved {len(rag_result.documents)} documents for category: {state['classification'].category}")
    ...
    async def generate_queries_node(self, state: SupportAgentState) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Generated {len(result)} refined search queries")
    ...
    async def context_refinement_node(self, state: SupportAgentState) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Refined context with {len(refined_rag_result.documents)} documents")
    ...
    async def escalation_node(self, state: SupportAgentState) -> Dict[str, Any]:
        ...
        logger.info(f"Ticket escalated after {processing_time:.2f} seconds")
